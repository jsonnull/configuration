...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "jsonnull";
    repo = "ALVR";
    rev = "7df9e07ddff5a48b3595cbcd6775fcb2a1b172ad";
    fetchSubmodules = true; # TODO devendor openvr
    hash = "sha256-ItfrV65WJeXkcfyjjBigH+q3B7ppuhRHbqzGKaQdNm8=";
  };
  ...
  postInstall = ''
    ...
    install -Dm644 ${src}/alvr/xtask/flatpak/alvr_icon.png $out/share/icons/hicolor/256x256/apps/alvr.png
